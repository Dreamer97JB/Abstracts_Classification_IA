...
from .text_variants import attach_text_metadata, load_governed_text_metadata
...
def build_theme_outputs(
    ...
    *,
    ...
    base_rows = input_rows.drop(columns=["text_input"], errors="ignore")
    merged = attach_text_metadata(base_rows, text_metadata=metadata)
    merged["theme_text"] = (
