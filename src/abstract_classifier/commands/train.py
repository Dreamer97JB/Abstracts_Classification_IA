...
def handle_command(args: argparse.Namespace) -> int:
    ...
    if config_path.name == "theory_pseudo_label.toml":
        ...
        if args.model_family:
            config = with_model_family(config, args.model_family)
...
def register(subparsers) -> None:
    ...
    parser.add_argument(
        ...
        help="Override the configured model family for this run.",
    )
